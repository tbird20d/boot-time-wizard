...
research boot-time tuning options for embedded Linux systems.
 ...
 * grab-boot-data.sh is a tool to collect information that is used for
   subsequent analysis
...
selecte optimization technique:
